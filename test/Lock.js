...
describe("FidoDido Testing", function () {
  ...
  beforeEach(async () => {
    ...
    yourContract = await contract.deploy(owner, "Fido", "FD", "www.baseuri.com/hidden", "0x33232dfda16210085aaf909ee81605eec687357f9028d171adedc184fdc3ff58");
  });
  ...
  describe("safeMint", () => {
    it("should mint a token if privateSale's conditions are met", async () => {
      ...
      await expect(yourContract.safeMint(1, "0xCAe968DC8e1BE15630Ddd5c06Ab90A6425383D9d", [
        ...
        "0x1eecccb5aa69363c56f2788e133e46b38f679b9895a39ae0d29e80cb88df6d97",
        "0x3d48607ddb7880906566c7e0deda194b9269b046879683398923eb6ded717a31"
      ], { value: price5 })).to.emit(yourContract, "Transfer");
      const price4 = ethers.parseEther("0.06");
      await expect(yourContract.safeMint(1, "0x6fee6A6Cc73C8ad635ABD2f25e3Bf98552dCC9a8",
        [
      ...
      await expect(yourContract.safeMint(1, "0xB2afcC303803968DF8672cBCEEcc3995aA962Ca2", [
      ...
      await expect(yourContract.safeMint(1, "0x7915BB50c60cdFA90C12070f6a6662406F21DE00", [
      ...
      await expect(yourContract.safeMint(1, "0x34Baffa584cF55d1CCF8d8A2762e938e6f765F3E", [
      ...
      await expect(yourContract.safeMint(1, "0xd218fbd3375ba42cec17f618df2ff039f7d9edc2", [
